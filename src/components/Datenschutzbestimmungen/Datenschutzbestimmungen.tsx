...
/>
  ...
  <h2 className="scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight first:mt-0" style={{marginTop: 80}}>Datenerfassung auf dieser Website</h2>

    
        <h4 className="scroll-m-20 text-xl font-semibold tracking-tight">Wer ist verantwortlich für die Datenerfassung auf dieser Website?</h4>
        ...
        <h4 className="scroll-m-20 text-xl font-semibold tracking-tight">Wie erfassen wir Ihre Daten?</h4>
        <p className="leading-7 [&:not(:first-child)]:mt-6">
        ...
        <h4 className="scroll-m-20 text-xl font-semibold tracking-tight">Wofür nutzen wir Ihre Daten?</h4>
        <p className="leading-7 [&:not(:first-child)]:mt-6">
        ...
        <h4 className="scroll-m-20 text-xl font-semibold tracking-tight">Welche Rechte haben Sie bezüglich Ihrer Daten?</h4>
        <p className="leading-7 [&:not(:first-child)]:mt-6">
        ...
        <h3 className="scroll-m-20 text-2xl font-semibold tracking-tight">Analyse-Tools und Tools von Drittanbietern</h3>
        <p className="leading-7 [&:not(:first-child)]:mt-6">
        ...
        <h2 className="scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight first:mt-0" style={{marginTop: 40}}>2. Hosting</h2>
  
        <h3 className="scroll-m-20 text-2xl font-semibold tracking-tight">Externes Hosting</h3>
        <p className="leading-7 [&:not(:first-child)]:mt-6">
        ...
        <p className="leading-7 [&:not(:first-child)]:mt-6">
          ...
          <a href="https://firebase.google.com/support/privacy/" target="_blank" className="gray-link">
        ...
        <h3 className="scroll-m-20 text-2xl font-semibold tracking-tight">Privacy-Shield-Abkommen</h3>
        <p className="leading-7 [&:not(:first-child)]:mt-6">
        ...
        <p className="leading-7 [&:not(:first-child)]:mt-6">
          ...
          <a href="https://policies.google.com/privacy" target="_blank" className="gray-link">
        ...
        <h2 className="scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight first:mt-0" style={{marginTop: 40}}>3. Allgemeine Hinweise und Pflichtinformationen</h2>
  
        <h3 className="scroll-m-20 text-2xl font-semibold tracking-tight">Datenschutz</h3>
        <p className="leading-7 [&:not(:first-child)]:mt-6">
        ...
        <h3 className="scroll-m-20 text-2xl font-semibold tracking-tight">Hinweis zur verantwortlichen Stelle</h3>
        <p className="leading-7 [&:not(:first-child)]:mt-6">Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist:</p>
        <p className="leading-7 [&:not(:first-child)]:mt-6">
        ...
        <p className="leading-7 [&:not(:first-child)]:mt-6">
          Telefon: <a href="tel:+4983823793" className="gray-link">+49 (0) 8382 3793</a>
          <br />
          E-Mail: <a href="mailto:hlps.developers@gmail.com" className="gray-link">hlps.developers@gmail.com</a>
        </p>
        ...
        <h3 className="scroll-m-20 text-2xl font-semibold tracking-tight">Speicherdauer</h3>
        <p className="leading-7 [&:not(:first-child)]:mt-6">
        ...
        <h3 className="scroll-m-20 text-2xl font-semibold tracking-tight">Allgemeine Hinweise zu den Rechtsgrundlagen der Datenverarbeitung auf dieser Website</h3>
        <p className="leading-7 [&:not(:first-child)]:mt-6">
          ...
          von Cookies oder in den Zugriff auf Informationen in Ihr Endgerät
          (z.&nbsp;B. via Device-Fingerprinting) eingewilligt haben, erfolgt die
          Datenverarbeitung zusätzlich auf Grundlage von §.
        </p>
      </div>
    );
};