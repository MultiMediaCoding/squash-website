...
export const skationary: App = {
  ...
  features: [
    {
      name: "Filter Options",
      description: "Easily filter your entries by difficulty level or the skateparks you visited.",
      image: "/images/Apps/Skationary/Features/FilterOptions.png",
    },
    {
      name: "Manage Locations",
      description: "Browse street spots and skateparks and link them to your tricks.",
      image: "/images/Apps/Skationary/Features/ManageLocations.png",
    },
    {
      name: "Easy Editing",
      description: "Forgot something? Easily edit or delete any entry as needed.",
  ...
  mockupFeatures: [
    {
      ...
      description: "Easily browse through all your saved tricks in one place and review your notes and videos. Looking for something specific? Just search by notes or titles.",
      alignment: "left",
...

    {
      ...
      description: "Access detailed information for each trick, including the video clip, trick name, difficulty level, notes, and creation date.",
      alignment: "right",
      softwareTarget: SoftwareTarget.iOS,
    },
    {
      ...
      description: "Upload videos, name your trick, set the difficulty, and add notes to track your progress. You can also link your skatepark.",
      alignment: "left",
      softwareTarget: SoftwareTarget.iOS,
    },
    {
      ...
      description: "Watch your recorded skate clips, track your progress, and even slow them down to 0.5 speed for detailed review.",
      alignment: "right",
      softwareTarget: SoftwareTarget.iOS,
    },
  ],
