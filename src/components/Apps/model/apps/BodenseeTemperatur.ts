...
export const bodenseeTemperatur: App = {
  ...
  features: [
    {
      ...
      description: "Easily access lake temperature from your home and lock screens.",
      image: "/images/Apps/BodenseeTemperatur/Features/WidgetIntegration.png",
    },
    {
      name: "Works with Siri",
      description: "Ask Siri for the current Lake Constance temperature anytime.",
  ...
  mockupFeatures: [
    ...
    {
      image: "/images/Apps/BodenseeTemperatur/MockupFeatures/FullTemperatureHistory.png",
      title: "Full Temperature History",
      subtitle: "Track Long-Term Temperature Trends",
      description: "Access a detailed temperature curve to see how the lake’s temperature has changed over time. Track historical trends and patterns.",
      alignment: "right",
      softwareTarget: SoftwareTarget.iOS,
    },
    {
      image: "/images/Apps/BodenseeTemperatur/MockupFeatures/VisualTemperature.png",
      title: "Visual Temperature ",
      subtitle: "Instinctively perceptible color design",
      description: "Color-coded indicators let you instantly see if the lake is warm or cold. Warmer colors show higher temperatures, and cooler shades represent lower ones.",
      alignment: "left",
      softwareTarget: SoftwareTarget.iOS,
    },
  ],
